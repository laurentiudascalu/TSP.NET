    ...
    static class Program
    {
        ...
        private static void S1()
        {
            using (var db = new ModelSelfRefrences())
            {
                ...
                var a = new SelfReference("prima");
                var b = new SelfReference("a doua");
                a.AddReference(new List<SelfReference>() { b });
                db.SelfReferences.AddRange(new List<SelfReference>() { a });
                db.SaveChanges();

                string res = "";
                var rs = db.SelfReferences.ToList();
                foreach (var x in rs)
                    res += x.Name + " ";
